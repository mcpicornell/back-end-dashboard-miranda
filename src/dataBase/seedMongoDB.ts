...
const getRandomArrayPhotosRoom = (roomType: string) => {
  switch (roomType){
    case "Single":
      return ["https://23c133e0c1637be1e07d-be55c16c6d91e6ac40d594f7e280b390.ssl.cf1.rackcdn.com/u/phhk/home/1a-Superior-Single-Room-min1.jpg",
      ...
      case "Double Bed":
      return ["https://www.residenthotels.com/wp-content/uploads/2022/06/The-Resident-Victoria-double-room-1400x928.jpg",
...
const generateBookingsAndRoomsData = async () => {
  ...
  for (let i = 0; i < 16; i++) {
    try {
      ...
      const amenityList = [
        "Shower", "Bath", "TV", "Sea Views", "WiFi", "Air-conditioning system"
      ]
      ...
      const booking = new Booking({
        ...
        orderDate: convertToDateFormat(faker.date.past({years: 2, refDate:'2023-01-01'})),
        checkIn: convertToDateFormat(faker.date.past({years: 1, refDate:'2023-06-15'})),
